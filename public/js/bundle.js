...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYW1yaGUiLCJhIjoiY2t3MjBjNTVpMXFrNDJ1cWl0YXpyNWR3aCJ9.Wqal4LFw6mpV---wg-aHCw';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/amrhe/ckw212ip0581314pakopp9wkt',
    // style URL
    scrollZoom: false // center: [-118, 34], // starting position [lng, lat]
  ...
  locations.forEach(function (location) {
    ...
    new mapboxgl.Marker({
      element: el,
      anchor: 'bottom'
    }).setLngLat(location.coordinates).addTo(map); //Add info popup

    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(location.coordinates).setHTML("<p>Day ".concat(location.day, ": ").concat(location.description, "</p>")).addTo(map); //Extends the map bounds to include the current location
...
var updatesSettings = /*#__PURE__*/function () {
  ...
  return function updatesSettings(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
...
var stripe = Stripe('pk_test_51JzNbEEHQ8Eg7Thfud3LBcT1grrFDAzJQzwQbNiM613Kk3ZG2xUEZXdOnghEcpH3KA8URGmBWDkRCN9sSzGN5Pr600nt2wG53v');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            console.log(session); // 2) Create checkout from + charge the card (process the payment)
...
var bookBtn = document.getElementById('book-tour'); // const bookBtn = document.querySelector('#book-tour');
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              console.log(form);
              _context.next = 8;
              return (0, _updateSettings.updatesSettings)(form, 'data');
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 7;
              return (0, _updateSettings.updatesSettings)({
...
if (bookBtn) {
  ...
  bookBtn.addEventListener('click', function (e) {
    e.target.textContent = 'Processing...'; // const tourId = e.targer.dataset.tourId;
